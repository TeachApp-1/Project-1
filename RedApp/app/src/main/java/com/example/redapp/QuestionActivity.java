...
import static com.example.redapp.SetsActivity.setsIDs;
import static com.example.redapp.SplashActivity.catList;
import static com.example.redapp.SplashActivity.selected_cat_index;
...
public class QuestionActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    private void changeQuestion(int selectedOption)
    {
        if(selectedOption == 0)
        {
            switch (questionList.get(quesNum).getCorrectAns())
                ...
                .setListener(new Animator.AnimatorListener() {
                    ...
                    public void onAnimationEnd(Animator animation) {
                            if(value == 0)
                            {
                                ...
                                if(viewNum != 0)
                                    ((Button)view).setBackgroundTintList(ColorStateList.valueOf(Color.parseColor("#000000")));
