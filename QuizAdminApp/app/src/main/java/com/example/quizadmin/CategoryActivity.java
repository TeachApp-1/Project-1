...
public class CategoryActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        getSupportActionBar().setTitle("קטגוריות");
                ...
                if(task.isSuccessful())
                {
                    ...
                    if(doc.exists())
                    {
                        ...
                        for(int i = 1;i <= count;i++)
                        {
                            ...
                            catList.add(new CategoryModel(catID,catName,"0","1")); //adding the category catList array
                        }
                        adapter = new CategoryAdapter(catList); //creating a new CategoryAdapter object to hold all categories in recycler view
