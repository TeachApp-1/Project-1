...
import static com.example.quizadmin.CategoryActivity.selectedCatIndex;
import static com.example.quizadmin.QuestionActivity.questionList;
import static com.example.quizadmin.SetsActivity.selectedSetIndex;
                        ...
                        firestore.collection("QUIZ").document(catList.get(selectedCatIndex).getId())
                                ...
                                .addOnSuccessListener(new OnSuccessListener<Void>()
                                {
                                    ...
                                    public void onSuccess(Void aVoid)
                                    {
                                        ...
                                        questionList.add(new QuestionModel(docID,questionStr,optionAStr,optionBStr,optionCStr,optionDStr,Integer.valueOf(answerStr)));
