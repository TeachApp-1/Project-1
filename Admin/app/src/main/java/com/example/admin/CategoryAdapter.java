...
{
    private List<com.example.admin.CategoryModel> catList;

    public CategoryAdapter(List<com.example.admin.CategoryModel> catList)
    {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public ViewHolder(@NonNull View itemView)
        {
            ...
            editDialog.getWindow().setLayout(ViewGroup.LayoutParams.WRAP_CONTENT,800);
        ...
        private void setData(String title,final int pos,final CategoryAdapter adapter)
        {
            ...
            itemView.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    Intent intent = new Intent(itemView.getContext(), com.example.admin.SetsActivity.class);
